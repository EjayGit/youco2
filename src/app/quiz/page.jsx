...
export default async function Quiz() {
  async function handleSubmit(e) {
    ...
    const travelCO2 =
      busMiles * busFactor +
      carMiles * carFactor +
      trainMiles * trainFactor +
      airMiles * (airFactor / 365);

    let homeCO2 = 0;
    if (formValues.energyUseage == "l") {
      if (gas == true) {
        homeCO2 += lowGas / numChecks;
      }
      if (coal == true) {
        homeCO2 += lowCoal / numChecks;
      }
      if (wood == true) {
        homeCO2 += lowWood / numChecks;
      }
      if (elec == true) {
        homeCO2 += lowElec / numChecks;
      }
      if (oil == true) {
        homeCO2 += lowOil / numChecks;
      }
      homeCO2 += lowElec;
    } else if (formValues.energyUseage == "m") {
      if (gas == true) {
        homeCO2 += medGas / numChecks;
      }
      if (coal == true) {
        homeCO2 += medCoal / numChecks;
      }
      if (wood == true) {
        homeCO2 += medWood / numChecks;
      }
      if (elec == true) {
        homeCO2 += medElec / numChecks;
      }
      if (oil == true) {
        homeCO2 += medOil / numChecks;
      }
      homeCO2 += lowElec;
    } else if (formValues.energyUseage == "h") {
      if (gas == true) {
        homeCO2 += highGas / numChecks;
      }
      if (coal == true) {
        homeCO2 += highCoal / numChecks;
      }
      if (wood == true) {
        homeCO2 += highWood / numChecks;
      }
      if (elec == true) {
        homeCO2 += highElec / numChecks;
      }
      if (oil == true) {
        homeCO2 += highOil / numChecks;
      }
      homeCO2 += lowElec;
    } else {
      // return error
  ...
  return (
    <>
      <form
        action={handleSubmit}
        id="co2Form"
        aria-label="Personal CO2 emmissions form"
      >
        ...
        <select id="energyUsage" name="energyUsage">
          <option value="l" aria-label="Low home energy user">
            Low
          </option>
          <option value="m" aria-label="Medium home energy user">
            Medium
          </option>
          <option value="h" aria-label="High home energy user">
            High
          </option>
        </select>
          ...
          <div id="heatField">
            ...
            <span>
              <input
                ...
                name="elecHeat"
                value="elec"
                aria-label="Electric heating user"
              />
        ...
        <fieldset id="travel">
          ...
          <span>
            ...
            <input
              ...
              min="0"
              name="busTravel"
              aria-label="Bus travel input miles per day"
            />
          </span>
          <span>
            <label htmlFor="carTravel">
              Car Travel
              <br />
              (miles/day)
            </label>
            <input
              ...
              min="0"
              name="carTravel"
              aria-label="Car travel input miles per day"
            />
          </span>
          <span>
            <label htmlFor="trainTravel">
              Train Travel
              <br />
              (miles/day)
            </label>
            <input
              ...
              min="0"
              name="trainTravel"
              aria-label="Train travel input miles per day"
            />
          </span>
          <span>
            <label htmlFor="airTravel">
              Air Travel
              <br />
              (miles/year)
            </label>
            <input
              ...
              min="0"
              name="airTravel"
              aria-label="Air travel input miles per year"
            />
          </span>
        </fieldset>
